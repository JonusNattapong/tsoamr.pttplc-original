...
data_autopoll_error = f""" SELECT DISTINCT TAG_ID FROM AMR_ERROR where TRUNC(DATA_DATE) =  TO_DATE('{date_system}', 'DD-MM-YYYY') and REPEAT = 1"""
...
input_dataautopoll = f"""INSERT INTO AMR_DATA_AUTOPOLL (DATA_DATE, METER_POLL_REPEAT1, ERROR_REPEAT1) VALUES (TO_DATE('{date_system}', 'DD-MM-YYYY'), '{df_data_autopoll_cleaned.shape[0]}','{df_data_autopoll_error.shape[0]}')"""
