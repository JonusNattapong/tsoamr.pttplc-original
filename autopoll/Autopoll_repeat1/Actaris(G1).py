...
#### Tul
from Modbus2Data import convert_raw_to_value_config
...
def convert_raw_to_value_config(data_type, raw_data):
    data = convert_raw_to_value_config(data_type, raw_data)   
    return data 
...
def convert_raw_to_value(data_type, raw_data):
    if data_type == "Date":
        ...
        formatted_date = modified_date.strftime('%d-%m-%Y %H:%M:%S')
...
log_file_error = 'C:\\Users\\Administrator\\Desktop\\autopoll\\Autopoll_repeat1\\Actaris(G1).log'
