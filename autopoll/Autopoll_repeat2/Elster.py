...
log_file_error = 'C:\\Users\\Administrator\\Desktop\\autopoll\\Autopoll_repeat2\\Elster-280.log'
...
logger_info.info(f"Elster EK-280 : Total sets processed: {total_sets}, Successful rows: {successful_rows}, Errors: {error_count}") 
...
logger_info_site.info(f"Elster EK-280 : Total site processed: {total_site}, Successful rows: {len(counter_1.keys())}, Errors: {len(counter.keys())}")     
