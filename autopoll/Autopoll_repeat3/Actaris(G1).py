...
log_file_error = 'C:\\Users\\Administrator\\Desktop\\autopoll\\Autopoll_repeat3\\Actaris(G1).log'
...
query = """
            SELECT
                ...
                FROM
                    ...
                    AMR_PORT_INFO
                WHERE
                    AMR_FIELD_METER.METER_POLL_REPEAT2=1 AND
...
for row in rows:
    try:
        ...
        update_pm = f"""UPDATE AMR_FIELD_METER SET METER_POLL_REPEAT2 = '0' WHERE METER_ID = '{METERID}' AND METER_STREAM_NO = '{run}'"""
        ...
        with cx_Oracle.connect(username, password, f"{hostname}:{port}/{service_name}") as connection:
                                        with connection.cursor() as cursor:
                                            ...
                                            connection.commit()
                                            print("update METER_POLL_REPEAT2 successfully")
...
log_file_info = 'C:\\Users\\Administrator\\Desktop\\autopoll\\Autopoll_repeat3\\total.log'
...
log_file_info_site = 'C:\\Users\\Administrator\\Desktop\\autopoll\\Autopoll_repeat3\\total_site.log'
